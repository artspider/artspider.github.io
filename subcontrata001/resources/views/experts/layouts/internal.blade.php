...
<div class=" min-h-screen flex flex-col">
    <header class="bg-black h-16 flex items-center justify-between fixed w-full z-50 flex-shrink-0">
        <svg class="text-main-yellow arrow-left w-6 h-6 ml-4" viewBox="0 0 20 20" fill="currentColor" >
            <path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd">
            </path>
        </svg>

        <!-- Logo -->
            <svg class="px-3 h-16 w-16 lg:h-40 lg:w-40 text-main-yellow mr-4" viewBox="0 0 354 246" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    @yield('content')
    <footer class="bg-black rounded-t-md h-16 flex justify-around items-center mt-10 flex-shrink-0 fixed bottom-0 w-full">
        <div class="icono">
