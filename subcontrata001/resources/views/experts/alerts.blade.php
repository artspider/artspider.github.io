...
@section('content')
<div class=" alerts flex-grow overflow-auto my-16 ">
    <div class="alerts--notification bg-orange-100 border-l-4 border-orange-500 flex rounded-lg shadow-lg mx-4 my-4 py-2">
    ...
    <div class="alerts--notification bg-purple-100 border-l-4 border-purple-500 flex rounded-lg shadow-lg mx-4 my-4 py-2">
        <div class="employer__date flex flex-col justify-center items-center ml-4 pr-4 border-r-2 border-gray-400">
            <img class="employer__avatar w-12 h-12 rounded-full mt-2 " src="img/avatar2.png" alt="">
    ...
    <div class="alerts--notification bg-red-100 border-l-4 border-red-500 flex rounded-lg shadow-lg mx-4 my-4 py-2">
        <div class="employer__date flex flex-col justify-center items-center ml-4 pr-4 border-r-2 border-gray-400">
            <img class="employer__avatar w-12 h-12 rounded-full mt-2 " src="img/avatar2.png" alt="">
            <div class="date text-black text-xl tracking-tighter mb-2"><span class="text-gray-400" >25</span>AGO</div>
        </div>
    ...
    <div class="alerts--notification bg-green-100 border-l-4 border-green-500 flex rounded-lg shadow-lg mx-4 my-4 py-2">
        <div class="employer__date flex flex-col justify-center items-center ml-4 pr-4 border-r-2 border-gray-400">
            <img class="employer__avatar w-12 h-12 rounded-full mt-2 " src="img/avatar2.png" alt="">
