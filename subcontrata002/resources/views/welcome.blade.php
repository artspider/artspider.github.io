    ...
    <div id="content flex flex-col min-h-screen w-full">
      ...
      >
        ...
        <div class="expertos-cards flex justify-evenly ">
          ...
          <div
            class="card1 hidden xl:block bg-gray-200 mx-4 my-4 rounded-lg shadow-lg xl:w-2/5 "
          >
            <div class="header--card1 flex my-6 ">
              <img
                class="h-24 w-24 mt-4 ml-6"
                src="./img/avatar1.png"
                alt="avatar1"
              />
              <div class="info--header-card1 text-sm ml-2 mt-4">
                ...
                <div class="pills-cards hidden md:flex flex-wrap px-2 py-2">
                  <span
                    class="inline-block bg-black rounded-full px-2 py-2 text-sm font-semibold text-gray-100 mr-1 mb-1"
                    >#photography</span
                  >
                  <span
                    class="inline-block bg-black rounded-full px-2 py-2 text-sm font-semibold text-gray-100 mr-1 mb-1"
            ...
            <p
              class="descripcion--expertos-cards text-justify font-semibold mx-6 mb-2"
            >
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Unde qui
              dicta ipsum, quo inventore cum maxime dolores non quia nihil.
            </p>
            <div class="mx-6">
              <button
                class="contactar--expertos-card btn btn--secondary text-sm font-bold w-full rounded-md py-6 mb-6"
              >
                Contactar
              </button>
            </div>
