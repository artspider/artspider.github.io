...
<body class=" bg-light-back h-full antialiased leading-none ">
...
<div id="content" class=" flex flex-col min-h-screen w-full justify-center">
    <header
        class=" w-full top-0 left-0 transition duration-700 mx-auto bg-black lg:flex lg:flex-row justify-between "
        id = "home"
    >
        <div class="container flex flex-no-wrap justify-between mx-auto "
        >
        <div class=" h-20 flex relative w-full mt-6 lg:mt-0 lg:w-1 z-50">
            <!-- Logo -->
            <div class="logo absolute bg-main-yellow ml-4 xl:ml-0 rounded-lg md:rounded-t-none md:rounded-b-lg ">
              <a href="{{ url('/') }}" >
        ...
        <!-- Menu lista -->
        <nav
            class="menu__lista  md:w-full md:h-full md:right-0 lg:flex lg:justify-end lg:items-center"
        >
            <ul class="flex h-full  items-center justify-end text-white font-semibold ml-6 lg:mr-4 pt-10 pb-6 lg:pt-0 lg:pb-0">
                <li class="ml-2 mr-8     px-3 py-2         lg:mr-0 lg:my-0 rounded bg-red-700 text-white hover:bg-red-500 hover:text-white"> <a href="">Registrate</a>  </li>
            </ul>
        </nav>
        <!-- Termina Menu lista -->
    </div>
